export const ELEMENTS = {
    MAIN_BANNER: {
        ...
        leftArrow: ':nth-child(5) > .vtex-slider-layout-0-x-sliderLayoutContainer > .vtex-slider-layout-0-x-sliderLeftArrow',
        rightArrow: ':nth-child(5) > .vtex-slider-layout-0-x-sliderLayoutContainer > .vtex-slider-layout-0-x-sliderRightArrow',
        firstDot: ':nth-child(5) > .vtex-slider-layout-0-x-sliderLayoutContainer > .vtex-slider-layout-0-x-paginationDotsContainer > .vtex-slider-layout-0-x-paginationDot--isActive',
        secondDot: ':nth-child(5) > .vtex-slider-layout-0-x-sliderLayoutContainer > .vtex-slider-layout-0-x-paginationDotsContainer > .bg-muted-3',
        ...
        secondImageMobile: 'body > div.render-container.render-route-store-home > div > div.vtex-store__template.bg-base > div > div:nth-child(2) > div > div:nth-child(3) > section > div.w-100.vtex-slider-layout-0-x-sliderTrackContainer.vtex-slider-layout-0-x-sliderTrackContainer--main-banner-mobile.overflow-hidden > div > div.vtex-slider-layout-0-x-slide.vtex-slider-layout-0-x-slide--main-banner-mobile.vtex-slider-layout-0-x-slide--firstVisible.vtex-slider-layout-0-x-slide--main-banner-mobile--firstVisible.vtex-slider-layout-0-x-slide--visible.vtex-slider-layout-0-x-slide--main-banner-mobile--visible.flex.relative > div > a > img',
        leftArrowMobile: '.flex-grow-1.w-100 > :nth-child(3) > .vtex-slider-layout-0-x-sliderLayoutContainer > .vtex-slider-layout-0-x-sliderLeftArrow',
        rightArrowMobile: '.flex-grow-1.w-100 > :nth-child(3) > .vtex-slider-layout-0-x-sliderLayoutContainer > .vtex-slider-layout-0-x-sliderRightArrow',
        firstDotMobile: '.flex-grow-1.w-100 > :nth-child(3) > .vtex-slider-layout-0-x-sliderLayoutContainer > .vtex-slider-layout-0-x-paginationDotsContainer > .vtex-slider-layout-0-x-paginationDot--isActive',
        secondDotMobile: '.flex-grow-1.w-100 > :nth-child(3) > .vtex-slider-layout-0-x-sliderLayoutContainer > .vtex-slider-layout-0-x-paginationDotsContainer > .bg-muted-3',
    ...
    CATEGORY_SECTION: {
        ...
        title: '.vtex-flex-layout-0-x-flexRowContent--categories-container > [style="width: 100%;"] > .vtex-flex-layout-0-x-flexCol > :nth-child(1) > .vtex-rich-text-0-x-container > .vtex-rich-text-0-x-wrapper > .lh-copy',
    ...
    CAROUSEL_FIRST: {
        container: ':nth-child(5) > .vtex-slider-layout-0-x-sliderLayoutContainer > .vtex-slider-layout-0-x-paginationDotsContainer > .bg-muted-3',
    ...
    YO_SECTION: {
        container: '.flex-grow-1.w-100 > :nth-child(9) > :nth-child(1)',
        title: '.vtex-flex-layout-0-x-flexCol--yoelijoesika-subcontainer > :nth-child(1) > .vtex-flex-layout-0-x-flexCol > :nth-child(1) > .vtex-rich-text-0-x-container > .vtex-rich-text-0-x-wrapper > .lh-copy',
    ...
    BLOG_CATALOG_SECTION: {
        ...
        subTitleBlog: 'p.lh-copy.vtex-rich-text-0-x-paragraph.vtex-rich-text-0-x-paragraph--middle-text-one',
        subTitleCatalog: 'p.lh-copy.vtex-rich-text-0-x-paragraph.vtex-rich-text-0-x-paragraph--middle-text-two',
